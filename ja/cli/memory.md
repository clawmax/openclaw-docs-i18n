title: "セマンティックインデックス作成と検索のためのOpenClaw CLIメモリコマンド"
description: "CLIコマンドを使用してセマンティックメモリを管理する方法を学びます: ステータスの確認、強制再インデックス作成、メモリプラグインを使用したインデックス済みコンテンツの検索。"
keywords: ["openclaw cli", "セマンティックメモリ", "メモリインデックス作成", "メモリ検索", "cliコマンド", "メモリプラグイン", "ベクトル検索", "エージェントメモリ"]
---
