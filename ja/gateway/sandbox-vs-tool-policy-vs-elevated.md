title: "OpenClaw サンドボックス vs ツールポリシー vs 高度なセキュリティ制御"
description: "OpenClawのサンドボックス、ツールポリシー、高度な制御の違いを学びましょう。ツールがどこで実行されるか、どのツールが許可されるか、execエスケープハッチの使用方法を理解します。"
keywords: ["openclaw サンドボックス", "ツールポリシー", "高度モード", "セキュリティ制御", "サンドボックス ジェイル", "docker バインド", "ツール許可リスト", "エージェント設定"]
---
