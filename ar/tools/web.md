title: "دليل أدوات الويب في OpenClaw: البحث وجلب التكوين"
description: "تعرّف على كيفية إعداد واستخدام أدوات web_search و web_fetch المدمجة في OpenClaw مع واجهات برمجة تطبيقات Perplexity أو Brave أو Gemini أو Grok أو Kimi للبحث على الويب واستخراج المحتوى."
keywords: ["أدوات ويب openclaw", "واجهة برمجة تطبيقات البحث على الويب", "بحث perplexity", "واجهة برمجة تطبيقات brave search", "تأريض gemini", "أداة جلب الويب", "تكوين واجهة برمجة التطبيقات", "إعداد مزود البحث"]
---
