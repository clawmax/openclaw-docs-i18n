title: "دليل موافقات التنفيذ لأمان وكيل OpenClaw AI"
description: "تعلم كيفية تكوين واستخدام موافقات التنفيذ للتحكم بأمان في الأوامر التي يمكن لوكلاء الذكاء الاصطناعي تشغيلها على أجهزة المضيف. ضع السياسات، وأدر قوائم السماح، وتعامل مع مطالبات المستخدم."
keywords: ["موافقات التنفيذ", "أمان الوكيل", "قائمة السماح للأوامر", "التنفيذ على المضيف", "سياج الحماية", "أدوات openclaw", "system.run", "سير عمل الموافقة"]
---
