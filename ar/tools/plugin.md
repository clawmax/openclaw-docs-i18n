title: "دليل إضافات مهارات OpenClaw: التثبيت، التكوين، وSDK"
description: "تعلم كيفية تثبيت، تكوين، وتطوير إضافات لـ OpenClaw. وسّع الوظائف باستخدام الإضافات الرسمية، مسارات HTTP، ومساعدات وقت التشغيل."
keywords: ["إضافات openclaw", "إضافات المهارات", "تثبيت الإضافات", "sdk الإضافات", "gateway rpc", "أدوات الوكيل", "بيان الإضافة", "مساعدات وقت التشغيل"]
---
