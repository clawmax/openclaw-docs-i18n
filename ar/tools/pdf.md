title: "توثيق أداة OpenClaw PDF لتحليل مستندات PDF"
description: "تعلم كيفية استخدام أداة OpenClaw PDF لتحليل واستخراج النص من ملفات PDF. قم بتكوين النماذج، والتعامل مع المدخلات، وفهم أوضاع التنفيذ لمستند واحد أو متعدد."
keywords: ["أداة pdf", "تحليل pdf", "openclaw pdf", "معالجة المستندات", "استخراج pdf", "ذكاء اصطناعي pdf", "تكامل pdf", "ذكاء اصطناعي متعدد الوسائط"]
---
