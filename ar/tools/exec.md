title: "وثائق أداة OpenClaw Exec لتنفيذ أوامر Shell"
description: "تعلم كيفية استخدام أداة OpenClaw Exec لتشغيل أوامر shell في المقدمة أو الخلفية، وضبط الأمان، وإدارة الموافقات، وتعيين تجاوزات الجلسة."
keywords: ["openclaw exec", "تنفيذ أوامر shell", "عملية خلفية", "أمان الحجرة الرملية", "موافقات exec", "تنفيذ المضيف", "أداة سطر الأوامر", "أتمتة مساحة العمل"]
---
