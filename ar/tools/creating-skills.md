title: "كيفية إنشاء مهارات مخصصة لمساعدات OpenClaw الذكية"
description: "تعلم كيفية توسيع قدرات مساعد OpenClaw الذكي عن طريق إنشاء مهارات مخصصة. دليل خطوة بخطوة لتعريف المهارات وإضافة الأدوات واتباع أفضل الممارسات."
keywords: ["مهارات openclaw", "إنشاء مهارة مخصصة", "تطوير المهارات", "قابلية توسيع المساعد الذكي", "برنامج تعليمي لـ skill.md", "clawhub", "أدوات متعددة الوكلاء", "مساحة عمل openclaw"]
---
