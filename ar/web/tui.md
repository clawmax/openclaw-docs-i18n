title: "دليل البدء السريع وأوامر واجهة المستخدم النصية (TUI) على الويب لـ OpenClaw"
description: "تعلم كيفية استخدام واجهة المستخدم النصية (TUI) على الويب لـ OpenClaw. دليل البدء السريع، وأوامر الشرطة المائلة، واختصارات لوحة المفاتيح، واستكشاف الأخطاء وإصلاحها لواجهة المستخدم الطرفية."
keywords: ["openclaw tui", "واجهة المستخدم الطرفية", "الواجهة على الويب", "عميل البوابة", "أوامر الشرطة المائلة", "اختصارات لوحة المفاتيح", "إدارة الجلسات", "استكشاف الأخطاء وإصلاحها"]
---
