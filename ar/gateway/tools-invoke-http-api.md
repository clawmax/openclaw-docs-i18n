title: "واجهة برمجة تطبيقات HTTP لبوابة OpenClaw لاستدعاء الأدوات مباشرة"
description: "تعلم كيفية استدعاء أدوات OpenClaw مباشرة عبر واجهة برمجة تطبيقات HTTP للبوابة. يغطي المصادقة، تنسيق الطلب، توجيه السياسة، وأوامر curl مثال."
keywords: ["بوابة openclaw", "واجهة برمجة تطبيقات http", "استدعاء أدوات", "نقطة نهاية api", "رمز Bearer", "سياسة الأداة", "مثال curl", "طلب POST"]
---
