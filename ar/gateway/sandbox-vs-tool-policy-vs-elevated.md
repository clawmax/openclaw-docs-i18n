title: "OpenClaw: الصندوق الرملي مقابل سياسة الأدوات مقابل ضوابط الأمان المتقدمة"
description: "تعرف على الفروق بين صندوق OpenClaw الرملي، وسياسة الأدوات، والضوابط المتقدمة. افهم مكان تشغيل الأدوات، والأدوات المسموح بها، وكيفية استخدام منفذ الهروب exec."
keywords: ["openclaw صندوق رملي", "سياسة الأدوات", "الوضع المتقدم", "ضوابط الأمان", "سجن الصندوق الرملي", "ربط docker", "القائمة المسموح بها للأدوات", "تكوين الوكيل"]
---
