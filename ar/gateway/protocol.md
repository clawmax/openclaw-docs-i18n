title: "وثائق بروتوكول WebSocket لبوابة OpenClaw"
description: "تعرف على بروتوكول WebSocket لبوابة OpenClaw لاتصالات العميل، عملية المصافحة، الأدوار، النطاقات، المصادقة، وتأطير API."
keywords: ["بوابة openclaw", "بروتوكول websocket", "وثائق api", "مصافحة العميل", "مصادقة الجهاز", "قدرات العقدة", "نطاقات المشغل", "نقل البوابة"]
---
