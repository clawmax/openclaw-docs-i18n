title: "دليل تكوين وتشغيل تسجيل OpenClaw Gateway"
description: "تعلم كيفية تكوين تسجيل الملفات والكونسول، ضبط مستويات السجلات، إدارة سجلات WebSocket، واستخدام الإخفاء للبيانات الحساسة في بوابة OpenClaw."
keywords: ["تسجيل openclaw", "سجلات البوابة", "تكوين السجلات", "سجلات websocket", "التقاط الكونسول", "إخفاء السجلات", "سجلات json", "مستويات السجلات"]
---
