title: "دليل أمان وتهيئة تجزئة OpenClaw Gateway"
description: "تعلم كيفية تهيئة تجزئة OpenClaw مع Docker لتنفيذ الأدوات بشكل آمن. تحكم في أوضاع التجزئة، ووصول مساحة العمل، والنقاط المخصصة، وإعدادات الأمان."
keywords: ["تجزئة openclaw", "أمان حاوية Docker", "عزل تنفيذ الأداة", "تهيئة التجزئة", "أمان البوابة", "تحكم وصول مساحة العمل", "متصفح التجزئة", "نقاط ربط مخصصة"]
---
