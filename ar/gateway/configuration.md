title: "دليل تكوين بوابة OpenClaw وبرنامج إعدادها التعليمي"
description: "تعلّم كيفية تكوين بوابة OpenClaw باستخدام JSON5. قم بإعداد القنوات، النماذج، الجلسات، العزل، الوظائف المجدولة، والتوجيه متعدد الوكلاء."
keywords: ["تكوين openclaw", "إعداد البوابة", "تكوين json5", "توجيه متعدد الوكلاء", "إدارة الجلسات", "العزل", "الوظائف المجدولة", "سياسة الرسائل المباشرة"]
---
