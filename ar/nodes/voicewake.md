title: "توثيق تهيئة عقدة الاستيقاظ الصوتي والبروتوكول"
description: "تعلم كيفية تكوين كلمات الاستيقاظ العالمية، فهم بروتوكول التخزين، وإدارة إعدادات الاستيقاظ الصوتي عبر عقد macOS وiOS وAndroid في OpenClaw."
keywords: ["الاستيقاظ الصوتي", "كلمات الاستيقاظ", "بوابة OpenClaw", "بروتوكول voicewake", "تهيئة العقدة", "الاستيقاظ الصوتي لنظام macOS", "الاستيقاظ الصوتي لنظام iOS", "إعدادات الصوت لنظام Android"]
---
