title: "تكوين وضُع مؤشرات الكتابة في OpenClaw"
description: "تعلّم كيفية تكوين مؤشرات الكتابة في OpenClaw، بما في ذلك الوضع الفوري ووضع التفكير ووضع الرسالة. تحكم في وقت بدء الكتابة وتواتر التحديث."
keywords: ["مؤشرات الكتابة", "تكوين OpenClaw", "إعدادات الوكيل الافتراضية", "وضع الكتابة", "فاصل الكتابة", "سلوك الدردشة", "حلقة النموذج", "دلتا التفكير"]
---
