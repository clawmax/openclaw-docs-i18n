title: "إعداد موفر OpenClaw Anthropic: مفتاح API ورمز Claude"
description: "تعلم كيفية مصادقة OpenClaw مع Anthropic باستخدام مفتاح API أو رمز setup-token. قم بتكوين تخزين المطالبات المؤقت، نوافذ سياق 1 مليون رمز، واستكشاف الأخطاء الشائعة وإصلاحها."
keywords: ["أنثروبيك", "واجهة برمجة تطبيقات كلود", "إعداد OpenClaw", "تخزين المطالبات المؤقت", "رمز الإعداد", "نافذة سياق 1 مليون", "كلود 4.6", "بيدروك كلود"]
---
