title: "تكوين Deepgram لتحويل الصوت إلى نص في OpenClaw"
description: "تعلم كيفية إعداد واستخدام مزود Deepgram لتحويل الصوت الوارد وملاحظات الصوت إلى نص في OpenClaw، بما في ذلك إعداد مفتاح API وخيارات التكوين."
keywords: ["deepgram", "تحويل الكلام إلى نص", "تحويل الصوت إلى نص", "openclaw", "ملاحظات صوتية", "nova-3", "تكوين المزود", "معالجة الصوت"]
---
