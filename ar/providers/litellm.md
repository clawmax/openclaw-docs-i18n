title: "دليل إعداد وتكوين تكامل OpenClaw مع LiteLLM"
description: "تعلم كيفية توجيه OpenClaw عبر LiteLLM لتتبع التكاليف المركزي، وتوجيه النماذج، والتسجيل. قم بتكوين المزودين وإدارة المفاتيح الافتراضية."
keywords: ["litellm", "openclaw", "توجيه النماذج", "تتبع التكاليف", "بوابة llm", "مفاتيح افتراضية", "متوافق مع openai", "تكامل api"]
---
