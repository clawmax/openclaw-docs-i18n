title: "دليل إعداد وتكوين إضافة OpenClaw لـ Tlon"
description: "تعلم كيفية ربط OpenClaw برسول Urbit اللامركزي Tlon للرسائل الخاصة والدردشات الجماعية. قم بتكوين الإضافات، التحكم في الوصول، واستكشاف الأخطاء الشائعة وإصلاحها."
keywords: ["tlon", "openclaw", "urbit", "رسول لامركزي", "إعداد الإضافة", "دردشة جماعية", "تكوين الرسائل الخاصة", "التحكم في الوصول"]
---
