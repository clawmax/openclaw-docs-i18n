title: "دليل تكامل OpenClaw مع بوت Feishu (Lark)"
description: "تعلم كيفية تثبيت وتكوين إضافة OpenClaw لـ Feishu. قم بتوصيل مساعد الذكاء الاصطناعي الخاص بك بـ Feishu/Lark باستخدام WebSocket للرسائل الآمنة دون الحاجة إلى عنوان ويب هوك عام."
keywords: ["feishu", "lark", "openclaw", "تكامل البوت", "websocket", "دردشة الفريق", "منصة المراسلة", "إعداد الإضافة"]
---
