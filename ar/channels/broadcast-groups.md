title: "دليل تكوين مجموعات البث في OpenClaw للفرق متعددة الوكلاء"
description: "تعلم كيفية تكوين مجموعات البث لنشر وكلاء ذكاء اصطناعي متخصصين متعددين في دردشة واتساب واحدة. قم بإعداد المعالجة المتوازية أو المتسلسلة للفرق."
keywords: ["مجموعات البث", "متعدد الوكلاء", "تكوين OpenClaw", "أتمتة واتساب", "فرق الوكلاء", "عزل الجلسة", "معالجة متوازية", "معالجة متسلسلة"]
---
