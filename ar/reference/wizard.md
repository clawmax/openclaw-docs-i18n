title: "مرجع معالج إعداد OpenClaw والوثائق التقنية"
description: "المرجع التقني الكامل لمعالج إعداد openclaw عبر سطر الأوامر. تعرف على سير العمل خطوة بخطوة للإعداد المحلي، والمصادقة، ومساحة العمل، وتهيئة البوابة والخلفية."
keywords: ["openclaw", "معالج الإعداد", "مرجع سطر الأوامر", "دليل الإعداد", "المصادقة", "تهيئة البوابة", "تثبيت الخلفية", "إعداد مساحة العمل"]
---
