title: "دليل مرجعي وتهيئة التخزين المؤقت للطلبات في OpenClaw"
description: "تعلم كيفية تكوين التخزين المؤقت للطلبات لتقليل تكاليف الرموز المميزة وتسريع الاستجابات. يغطي هذا الدليل إعدادات cacheRetention ودعم المزود وأنماط الضبط."
keywords: ["التخزين المؤقت للطلبات", "احتفاظ التخزين المؤقت", "تقليل تكلفة الرموز المميزة", "أنثروبيك كلود", "تهيئة OpenClaw", "تشخيص التخزين المؤقت", "تقليم الجلسة", "التخزين المؤقت لـ Bedrock"]
---
