title: "دليل مرجعي لاستخدام وتكاليف رمز OpenClaw"
description: "تعرف على كيفية تتبع OpenClaw للرموز المميزة (Tokens)، وتقدير التكاليف، وإدارة السياق. اكتشف الأوامر لمراقبة الاستخدام واستراتيجيات تقليل استهلاك الرموز المميزة."
keywords: ["رموز openclaw", "استخدام الرموز المميزة", "تقدير التكلفة", "نافذة السياق", "التخزين المؤقت للمطالبات", "مهلة صلاحية التخزين المؤقت", "تقليل استخدام الرموز", "مطالبة النظام"]
---
