title: "قائمة التحقق لإصدار OpenClaw ودليل نشر الإصدارات"
description: "دليل خطوة بخطة لإصدار ونشر إصدارات OpenClaw. تعرف على فحوصات ما قبل الإطلاق، وعملية البناء، ونشر npm، وتوزيع تطبيق macOS."
keywords: ["إصدار openclaw", "قائمة التحقق للإصدار", "نشر npm", "إدارة الإصدارات", "تغذية sparkle appcast", "توزيع تطبيق macOS", "سجل التغييرات", "نشر الإضافات"]
---
