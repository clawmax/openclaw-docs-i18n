title: "تسجيل macOS لتصحيح أخطاء وتشخيص تطبيق OpenClaw"
description: "تعلم كيفية تمكين سجلات الملفات الدوارة والتسجيل الموحد مع البيانات الخاصة لتصحيح تطبيق OpenClaw لنظام macOS. قم بتكوين مستوى التفصيل وعرض الحمولات الحساسة."
keywords: ["تسجيل macOS", "تشخيص OpenClaw", "سجل ملف دوار", "تسجيل موحد", "تصحيح تطبيق ماك", "تسجيل بيانات خاصة", "سجل jsonl", "تكوين السجل"]
---
