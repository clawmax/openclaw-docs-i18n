title: "دليل إعداد وتهيئة التحكم عن بُعد لـ OpenClaw على نظام macOS"
description: "تعلّم كيفية تهيئة تطبيق macOS كجهاز تحكم عن بُعد لبوابة OpenClaw عبر SSH أو الاتصال المباشر. يتضمن خطوات الإعداد، والأوضاع، واستكشاف الأخطاء وإصلاحها."
keywords: ["openclaw تحكم عن بعد", "macos ssh gateway", "عن بعد عبر ssh", "تطبيق openclaw لنظام mac", "تهيئة البوابة", "نفق ssh", "websocket مباشر", "استكشاف أخطاء openclaw وإصلاحها"]
---
