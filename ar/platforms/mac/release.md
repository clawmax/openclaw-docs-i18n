title: "دليل توقيع وتوزيع إصدار OpenClaw لنظام macOS"
description: "تعلم كيفية بناء وتوقيع واعتماد ونشر إصدارات التوزيع لتطبيق OpenClaw لنظام macOS مع تحديثات Sparkle التلقائية. يتضمن المتطلبات الأساسية ونصوص التغليف."
keywords: ["إصدار macos", "تحديثات sparkle", "توقيع معرف المطور", "اعتماد التطبيق", "إنشاء appcast", "توزيع macos", "تغليف تطبيق mac", "أتمتة الإصدار"]
---
