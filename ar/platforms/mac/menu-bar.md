title: "دليل حالة وتتبع نشاط تطبيق شريط القوائم OpenClaw لنظام macOS"
description: "تعرف على كيفية عرض تطبيق شريط القوائم OpenClaw لنظام macOS لحالات عمل الوكيل، وأولوية الجلسة، وأيقونات النشاط، وتجاوزات التصحيح لمراقبة مهام الذكاء الاصطناعي."
keywords: ["شريط قوائم macos", "تطبيق OpenClaw المرافق", "حالة عمل الوكيل", "مراقبة النشاط", "أولوية الجلسة", "تجاوز التصحيح", "Iconstate enum", "استيعاب الأحداث"]
---
