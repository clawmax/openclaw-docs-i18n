title: "دليل إعداد معالج إعداد OpenClaw عبر سطر الأوامر (CLI)"
description: "تعلّم كيفية إعداد OpenClaw باستخدام معالج الإعداد الموصى به. قم بتكوين البوابات المحلية أو البعيدة، والقنوات، والمهارات، وإعدادات مساحة العمل الافتراضية في تدفق موجه واحد."
keywords: ["إعداد openclaw", "معالج سطر الأوامر", "إعداد البوابة", "تكوين الوكيل", "إعداد openclaw", "معجب الإعداد", "بوابة محلية", "بوابة بعيدة"]
---
