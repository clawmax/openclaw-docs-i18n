title: "أوامر OpenClaw CLI للخلفية لإدارة خدمة البوابة"
description: "تعلم كيفية استخدام أوامر CLI للخلفية القديمة openclaw daemon لتثبيت، بدء، إيقاف، وإدارة حالة ودورة حياة خدمة البوابة."
keywords: ["خلفية openclaw", "خدمة البوابة", "أوامر CLI", "إدارة الخدمة", "تثبيت الخدمة", "حالة الخدمة", "الاسم المستعار القديم", "openclaw cli"]
---
