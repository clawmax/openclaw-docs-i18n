title: "إدارة هوات OpenClaw CLI: أتمتة قائمة على الأحداث للوكيل"
description: "تعلم كيفية إدارة هوات وكيل OpenClaw: عرض القائمة، تمكين، تعطيل، تثبيت، وتحديث الأتمتة القائمة على الأحداث لأوامر مثل /new وبدء التشغيل للبوابة."
keywords: ["هوات openclaw", "هوات cli", "أتمتة الوكيل", "هوات قائمة على الأحداث", "هوات الأوامر", "بدء تشغيل البوابة", "إدارة الهوات", "ذاكرة الجلسة"]
---
