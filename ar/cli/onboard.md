title: "دليل إعداد معالج إعداد OpenClaw CLI وأمثلة"
description: "تعلم كيفية استخدام أمر openclaw onboard لإعداد البوابة المحلية أو البعيدة. يتضمن معالج تفاعلي، أتمتة غير تفاعلية، وتكوين موفر مخصص."
keywords: ["openclaw cli", "معالج الإعداد", "إعداد البوابة", "أتمتة سطر الأوامر", "إعداد غير تفاعلي", "موفر مخصص", "مرجع السر", "openclaw onboard"]
---
