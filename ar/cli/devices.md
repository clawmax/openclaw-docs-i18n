title: "أوامر OpenClaw CLI للأجهزة لإدارة الاقتران والرموز المميزة"
description: "تعلم كيفية عرض قائمة الأجهزة، الموافقة عليها، إزالتها، وإدارة طلبات اقتران الأجهزة والرموز المميزة المحددة للأجهزة باستخدام أوامر OpenClaw CLI."
keywords: ["أجهزة openclaw", "اقتران الأجهزة", "أوامر cli", "رمز الجهاز", "طلبات الاقتران", "تدوير الرمز المميز", "إدارة الأجهزة", "الموافقة على الجهاز"]
---
