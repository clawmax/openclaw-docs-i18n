title: "أوامر CLI لـ OpenClaw Sandbox لإدارة حاويات Docker"
description: "تعلم كيفية إدارة حاويات بيئة الاختبار المعزولة (Sandbox) في OpenClaw باستخدام أوامر CLI. اعرض قائمة الحاويات، وأعد إنشائها، وافحص حاويات Docker لتنفيذ الوكيل المعزول بعد التحديثات."
keywords: ["openclaw sandbox", "حاويات docker", "أوامر cli", "عزل الوكيل", "إدارة بيئة الاختبار", "إعادة إنشاء الحاوية", "تكوين بيئة الاختبار", "openclaw cli"]
---
