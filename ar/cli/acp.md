title: "جسر OpenClaw ACP CLI لتكامل بروتوكول عميل الوكيل"
description: "تعلم كيفية استخدام جسر OpenClaw ACP CLI لتوصيل بيئات التطوير المتكاملة عبر بروتوكول عميل الوكيل ببوابة Gateway. قم بتكوين الجلسات، وتصحيح الأخطاء مع العميل، وإعداد محرر Zed."
keywords: ["openclaw acp", "بروتوكول عميل الوكيل", "جسر سطر الأوامر", "بوابة websocket", "إعداد محرر zed", "إدارة الجلسات", "تصحيح عميل acp", "تكامل بيئة التطوير المتكاملة"]
---
