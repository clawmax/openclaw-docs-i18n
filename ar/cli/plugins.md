title: "دليل أوامر إضافات OpenClaw CLI لإدارة الامتدادات"
description: "تعلم كيفية سرد، تثبيت، تمكين، تحديث، وإزالة إضافات OpenClaw CLI. إدارة أمان الإضافات، الإصدارات المثبتة، والامتدادات المضمنة."
keywords: ["إضافات openclaw", "إدارة إضافات سطر الأوامر", "تثبيت الإضافات", "أوامر الإضافات", "امتدادات البوابة", "أمان الإضافات", "تحديث الإضافات", "إزالة الإضافات"]
---
