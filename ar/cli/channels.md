title: "دليل أوامر OpenClaw CLI للقنوات لإدارة حسابات الدردشة"
description: "تعلم كيفية إدارة حسابات قنوات الدردشة، إضافة أو إزالة الحسابات، تحويل الأسماء إلى معرفات، واستكشاف حالة التشغيل باستخدام أوامر OpenClaw CLI."
keywords: ["openclaw cli", "أوامر القنوات", "حسابات الدردشة", "حالة البوابة", "إضافة حساب قناة", "استكشاف أخطاء القنوات", "تحويل معرفات القنوات", "قدرات القناة"]
---
