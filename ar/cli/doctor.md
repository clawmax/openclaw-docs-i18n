title: "أمر OpenClaw Doctor CLI للفحوصات الصحية والإصلاحات السريعة"
description: "تعلم كيفية استخدام أمر openclaw doctor لتشغيل الفحوصات الصحية وإصلاح المشكلات واستكشاف أخطاء البوابة والقنوات. يتضمن أمثلة ونصائح لنظام macOS."
keywords: ["openclaw doctor", "فحص صحي لـ CLI", "استكشاف أخطاء البوابة", "إصلاح CLI", "استكشاف أخطاء OpenClaw", "macOS launchctl", "أوامر CLI", "تشخيص النظام"]
---
