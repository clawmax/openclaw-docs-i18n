title: "وثائق خط أنابيب OpenClaw CI ونظرة عامة على المهام"
description: "تعرف على خط أنابيب OpenClaw CI، ونطاقه الذكي، وأغراض المهام، والأوامر المحلية المكافئة للفحوصات والاختبارات والإصدارات."
keywords: ["خط أنابيب التكامل المستمر", "التكامل المستمر", "النطاق الذكي", "مهام التكامل المستمر", "أوامر التطوير المحلي", "pnpm check", "منفذ blacksmith", "سير عمل المساهمة"]
---
