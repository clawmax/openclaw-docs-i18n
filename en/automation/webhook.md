...
-   `openclaw webhooks gmail setup` writes `hooks.gmail` config for `openclaw webhooks gmail run`. See [Gmail Pub/Sub](./gmail-pubsub.md) for the full Gmail watch flow.
...
[Automation Troubleshooting](./troubleshooting.md)[Gmail PubSub](./gmail-pubsub.md)
