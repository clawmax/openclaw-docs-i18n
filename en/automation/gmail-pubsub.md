...
-   OpenClaw hooks enabled (see [Webhooks](./webhook.md)).
...
To customize payload handling further, add `hooks.mappings` or a JS/TS transform module under `~/.openclaw/hooks/transforms` (see [Webhooks](./webhook.md)).
