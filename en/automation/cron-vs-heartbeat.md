...
See [Heartbeat](../gateway/heartbeat.md) for full configuration.
...
See [Cron jobs](./cron-jobs.md) for full CLI reference.
...
See [Lobster](../tools/lobster.md) for full usage and examples.
...
-   [Heartbeat](../gateway/heartbeat.md) - full heartbeat configuration
-   [Cron jobs](./cron-jobs.md) - full cron CLI and API reference
-   [System](../cli/system.md) - system events + heartbeat controls

[Cron Jobs](./cron-jobs.md)[Automation Troubleshooting](./troubleshooting.md)
