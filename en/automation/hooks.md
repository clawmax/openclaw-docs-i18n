...
-   **Webhooks**: external HTTP webhooks that let other systems trigger work in OpenClaw. See [Webhook Hooks](./webhook.md) or use `openclaw webhooks` for Gmail helper commands.

Hooks can also be bundled inside plugins; see [Plugins](../tools/plugin.md#plugin-hooks). Common uses:
...
-   **`tool_result_persist`**: transform tool results before they are written to the session transcript. Must be synchronous; return the updated tool result payload or `undefined` to keep it as-is. See [Agent Loop](../concepts/agent-loop.md).
...
Saves session context to memory when you issue `/new`. **Events**: `command:new` **Requirements**: `workspace.dir` must be configured **Output**: `/memory/YYYY-MM-DD-slug.md` (defaults to `~/.openclaw/workspace`) **What it does**:
...
-   [CLI Reference: hooks](../cli/hooks.md)
-   [Bundled Hooks README](https://github.com/openclaw/openclaw/tree/main/src/hooks/bundled)
-   [Webhook Hooks](./webhook.md)
-   [Configuration](../gateway/configuration.md#hooks)

[OpenProse](../prose.md)[Cron Jobs](./cron-jobs.md)
