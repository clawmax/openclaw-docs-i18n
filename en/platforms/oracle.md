...
-   [Gateway remote access](../gateway/remote.md) — other remote access patterns
-   [Tailscale integration](../gateway/tailscale.md) — full Tailscale docs
-   [Gateway configuration](../gateway/configuration.md) — all config options
-   [DigitalOcean guide](./digitalocean.md) — if you want paid + easier signup
-   [Hetzner guide](../install/hetzner.md) — Docker-based alternative
