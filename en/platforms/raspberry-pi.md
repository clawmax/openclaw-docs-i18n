...
-   [Linux guide](./linux.md) — general Linux setup
-   [DigitalOcean guide](./digitalocean.md) — cloud alternative
-   [Hetzner guide](../install/hetzner.md) — Docker setup
-   [Tailscale](../gateway/tailscale.md) — remote access
-   [Nodes](../nodes.md) — pair your laptop/phone with the Pi gateway

[Oracle Cloud](./oracle.md)[macOS Dev Setup](./mac/dev-setup.md)
