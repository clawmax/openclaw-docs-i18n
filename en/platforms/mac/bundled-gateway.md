...
-   `ai.openclaw.gateway` (or `ai.openclaw.`; legacy `com.openclaw.*` may remain)

Plist location (per‑user):

-   `~/Library/LaunchAgents/ai.openclaw.gateway.plist` (or `~/Library/LaunchAgents/ai.openclaw..plist`)
...
[macOS Release](./release.md)[macOS IPC](./xpc.md)
