...
See [Session Pruning](../concepts/session-pruning.md) for full behavior.
...
-   [Token Use and Costs](./token-use.md)
-   [Session Pruning](../concepts/session-pruning.md)
-   [Gateway Configuration Reference](../gateway/configuration-reference.md)

[SecretRef Credential Surface](./secretref-credential-surface.md)[API Usage and Costs](./api-usage-costs.md)
