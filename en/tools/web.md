...
These are **not** browser automation. For JS-heavy sites or logins, use the [Browser tool](./browser.md).
...
See [Perplexity Search setup](../perplexity.md) and [Brave Search setup](../brave-search.md) for provider-specific details.
...
-   See [Firecrawl](./firecrawl.md) for key setup and service details.
-   Responses are cached (default 15 minutes) to reduce repeated fetches.
-   If you use tool profiles/allowlists, add `web_search`/`web_fetch` or `group:web`.
-   If the API key is missing, `web_search` returns a short setup hint with a docs link.

[Thinking Levels](./thinking.md)[Browser (OpenClaw-managed)](./browser.md)
