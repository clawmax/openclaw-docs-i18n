...
-   **Compatibility:** OpenClaw still accepts legacy `MiniMax-M2.5-Lightning` configs, but prefer `MiniMax-M2.5-highspeed` for new setup.
...
-   See [/concepts/model-providers](../concepts/model-providers.md) for provider rules.
