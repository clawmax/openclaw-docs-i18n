...
> **⚠️** This path is technical compatibility only. Anthropic has blocked some subscription usage outside Claude Code in the past. You must decide for yourself whether to use it and verify Anthropic’s current terms before relying on it.
...
-   [Anthropic provider](./anthropic.md) - Native OpenClaw integration with Claude setup-token or API keys
-   [OpenAI provider](./openai.md) - For OpenAI/Codex subscriptions
