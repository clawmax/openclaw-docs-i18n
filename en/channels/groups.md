...
![Group message flow](../images/channels-groups-flow.svg.md) If you want…
...
> If you need truly separate workspaces/personas (“personal” and “public” must never mix), use a second agent + bindings. See [Multi-Agent Routing](../concepts/multi-agent.md).
...
-   Configuration keys and defaults: [Gateway configuration](../gateway/configuration.md#agentsdefaultssandbox)
-   Debugging why a tool is blocked: [Sandbox vs Tool Policy vs Elevated](../gateway/sandbox-vs-tool-policy-vs-elevated.md)
-   Bind mounts details: [Sandboxing](../gateway/sandboxing.md#custom-bind-mounts)
...
-   `toolsBySender`: per-sender overrides within the group. Use explicit key prefixes: `id:`, `e164:`, `username:`, `name:`, and `"*"` wildcard. Legacy unprefixed keys are still accepted and matched as `id:` only.
...
See [Group messages](./group-messages.md) for WhatsApp-only behavior (history injection, mention handling details).

[Group Messages](./group-messages.md)[Broadcast Groups](./broadcast-groups.md)
