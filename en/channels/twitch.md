...
Use `channels.twitch.accounts` with per-account tokens. See [`gateway/configuration`](../gateway/configuration.md) for the shared pattern. Example (one bot account in two channels):
