...
-   [Multi-Agent Configuration](../tools/multi-agent-sandbox-tools.md)
-   [Routing Configuration](./channel-routing.md)
-   [Session Management](../concepts/session.md)

[Groups](./groups.md)[Channel Routing](./channel-routing.md)
