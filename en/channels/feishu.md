...
![Create enterprise app](../images/channels-feishu-step2-create-app.png.md)
...
❗ **Important:** keep the App Secret private. ![Get credentials](../images/channels-feishu-step3-credentials.png.md)
...
![Configure permissions](../images/channels-feishu-step4-permissions.png.md)
...
![Enable bot capability](../images/channels-feishu-step5-bot-capability.png.md)
...
⚠️ If the gateway is not running, the long-connection setup may fail to save. ![Configure event subscription](../images/channels-feishu-step6-event-subscription.png.md)
...
![Verification Token location](../images/channels-feishu-verification-token.png.md)
...
Full configuration: [Gateway configuration](../gateway/configuration.md) Key options:
