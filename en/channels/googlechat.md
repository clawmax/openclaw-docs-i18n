...
Your public webhook URL will be: `https://<node-name>..ts.net/googlechat` Your private dashboard stays tailnet-only: `https://<node-name>..ts.net:8443/` Use the public URL (without `:8443`) in the Google Chat app config.
...
Secrets reference details: [Secrets Management](../gateway/secrets.md).
