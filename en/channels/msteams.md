...
If you choose Teams during configure/onboarding and a git checkout is detected, OpenClaw will offer the local install path automatically. Details: [Plugins](../tools/plugin.md)
...
-   Session keys follow the standard agent format (see [/concepts/session](../concepts/session.md)):
...
[Mattermost](./mattermost.md)[Nextcloud Talk](./nextcloud-talk.md)
