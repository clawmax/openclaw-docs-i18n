...
-   Optional channel default account: `channels..defaultAccount` chooses which account is used when an outbound path does not specify `accountId`.
...
[Broadcast Groups](./broadcast-groups.md)[Channel Location Parsing](./location.md)
