...
Security context: [Security](../gateway/security.md)

## 1) DM pairing (inbound chat access)

When a channel is configured with DM policy `pairing`, unknown senders get a short code and their message is **not processed** until you approve. Default DM policies are documented in: [Security](../gateway/security.md) Pairing codes:
...
-   Security model + prompt injection: [Security](../gateway/security.md)
-   Updating safely (run doctor): [Updating](../install/updating.md)
-   Channel configs:
    ...
    -   iMessage (legacy): [iMessage](./imessage.md)
