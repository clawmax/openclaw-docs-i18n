...
> **ℹ️** Despite the name, this generates your first token — nothing is being “reset.”
...
### Step 5: Enable Developer Mode and collect your IDs
...
### Step 7: Step 0: Set your bot token securely (do not send it in chat)
...
### Step 8: Configure OpenClaw and pair
...
### Step 9: Approve first DM pairing
...
> **ℹ️** Token resolution is account-aware. Config token values win over env fallback. `DISCORD_BOT_TOKEN` is only used for the default account.
...
### Step 1: Add your server to the guild allowlist
...
### Step 2: Allow responses without @mention
...
### Step 3: Plan for memory in guild channels
...
See [Slash commands](../tools/slash-commands.md) for command catalog and behavior. Default slash command settings:
...
See [Sub-agents](../tools/subagents.md), [ACP Agents](../tools/acp-agents.md), and [Configuration Reference](../gateway/configuration-reference.md).
...
See [ACP Agents](../tools/acp-agents.md) for binding behavior details.
...
-   [Configuration reference - Discord](../gateway/configuration-reference.md#discord)
