...
More detail: [/concepts/oauth](./oauth.md) Credential types:
...
See [Gateway configuration](../gateway/configuration.md) for:
...
See [Models](./models.md) for the broader model selection and fallback overview.

[Model Providers](./model-providers.md)[Anthropic](../providers/anthropic.md)
