...
See [Memory](./memory.md) for the workflow and automatic memory flush.
...
4.  If you need sessions, copy `~/.openclaw/agents//sessions/` from the old machine separately.

## Advanced notes

-   Multi-agent routing can use different workspaces per agent. See [Channel routing](../channels/channel-routing.md) for routing configuration.
