...
You can control the prompt format with `agents.defaults.timeFormat` (`auto` | `12` | `24`). See [Date & Time](../date-time.md) for the full behavior and examples.

[Usage Tracking](./usage-tracking.md)[Credits](../reference/credits.md)
