...
-   Messaging channels can choose queue modes (collect/steer/followup) that feed this lane system. See [Command Queue](./queue.md).
...
-   See [System prompt](./system-prompt.md) for what the model sees.
...
See [Hooks](../automation/hooks.md) for setup and examples.
...
See [Plugins](../tools/plugin.md#plugin-hooks) for the hook API and registration details.
...
-   See [Streaming](./streaming.md) for chunking and block reply behavior.
...
-   See [Compaction](./compaction.md) for the compaction pipeline.
...
[Agent Runtime](./agent.md)[System Prompt](./system-prompt.md)
