...
Details: [Gateway protocol](../gateway/protocol.md), [Pairing](../channels/pairing.md), [Security](../gateway/security.md).
...
[Pi Integration Architecture](../pi.md)[Agent Runtime](./agent.md)
