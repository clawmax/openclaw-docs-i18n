...
Before compaction, OpenClaw can run a **silent memory flush** turn to store durable notes to disk. See [Memory](./memory.md) for details and config.
...
See [/concepts/session-pruning](./session-pruning.md) for pruning details.
...
See [OpenAI provider](../providers/openai.md) for model params and overrides.
