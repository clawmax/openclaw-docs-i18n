...
This page covers **LLM/model providers** (not chat channels like WhatsApp/Telegram). For model selection rules, see [/concepts/models](./models.md).
...
See [/providers/kilocode](../providers/kilocode.md) for setup details.
...
-   Hugging Face Inference: `huggingface` (`HUGGINGFACE_HUB_TOKEN` or `HF_TOKEN`) — OpenAI-compatible router; example model: `huggingface/deepseek-ai/DeepSeek-R1`; CLI: `openclaw onboard --auth-choice huggingface-api-key`. See [Hugging Face (Inference)](../providers/huggingface.md).
...
See [/providers/qwen](../providers/qwen.md) for setup details and notes.
...
See [/providers/minimax](../providers/minimax.md) for setup details, model options, and config snippets.
...
Ollama is automatically detected when running locally at `http://127.0.0.1:11434/v1`. See [/providers/ollama](../providers/ollama.md) for model recommendations and custom configuration.
...
See [/providers/vllm](../providers/vllm.md) for details.
...
See also: [/gateway/configuration](../gateway/configuration.md) for full configuration examples.
