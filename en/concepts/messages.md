...
See [Configuration](../gateway/configuration.md) for full schema.
...
Details: [Streaming + chunking](./streaming.md).
...
Details: [Thinking + reasoning directives](../tools/thinking.md) and [Token use](../reference/token-use.md).
...
Details: [Configuration](../gateway/configuration.md#messages) and channel docs.

[Presence](./presence.md)[Streaming and Chunking](./streaming.md)
