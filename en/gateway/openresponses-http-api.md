...
-   `POST /v1/responses`
-   Same port as the Gateway (WS + HTTP multiplex): `http://<gateway-host>:/v1/responses`
...
See [Security](./security.md) and [Remote access](./remote.md).
...
### function\_call\_output (turn-based tools)
...
-   For internet-exposed gateways, apply network egress controls in addition to app-level guards. See [Security](./security.md).
