...
-   **Examples:** [exe.dev](../install/exe-dev.md) (easy VM) or [Hetzner](../install/hetzner.md) (production VPS).
...
Runbook: [macOS remote access](../platforms/mac/remote.md).
...
Guide: [Tailscale](./tailscale.md) and [Web overview](../web.md).
...
-   **Nodes do not run the gateway service.** Only one gateway should run per host unless you intentionally run isolated profiles (see [Multiple gateways](./multiple-gateways.md)).
...
The macOS menu bar app can drive the same setup end-to-end (remote status checks, WebChat, and Voice Wake forwarding). Runbook: [macOS remote access](../platforms/mac/remote.md).
...
Deep dive: [Security](./security.md).

[Bonjour Discovery](./bonjour.md)[Remote Gateway Setup](./remote-gateway-readme.md)
