...
-   [Security](./security.md) — full security guide
-   [Configuration](./configuration.md) — config reference
-   [Remote Access](./remote.md) — other remote access patterns
-   [Tailscale](./tailscale.md) — simpler alternative for tailnet-only access
