...
See [Sandboxing](./sandboxing.md) for the full matrix (scope, workspace mounts, images).
...
See [Elevated Mode](../tools/elevated.md).
...
[Sandboxing](./sandboxing.md)[Gateway Protocol](./protocol.md)
