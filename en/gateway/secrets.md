...
-   CLI commands: [secrets](../cli/secrets.md)
-   Plan contract details: [Secrets Apply Plan Contract](./secrets-plan-contract.md)
-   Credential surface: [SecretRef Credential Surface](../reference/secretref-credential-surface.md)
-   Auth setup: [Authentication](./authentication.md)
-   Security posture: [Security](./security.md)
-   Environment precedence: [Environment Variables](../help/environment.md)

[Auth credential semantics](../auth-credential-semantics.md)[Secrets Apply Plan Contract](./secrets-plan-contract.md)
