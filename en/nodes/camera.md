...
The easiest way to get attachments is via the CLI helper, which writes decoded media to a temp file and prints `MEDIA:`. Examples:
...
[Audio and Voice Notes](./audio.md)[Talk Mode](./talk.md)
