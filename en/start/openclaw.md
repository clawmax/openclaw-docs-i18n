...
-   OpenClaw installed and onboarded — see [Getting Started](./getting-started.md) if you haven’t done this yet
...
Full workspace layout + backup guide: [Agent workspace](../concepts/agent-workspace.md) Memory workflow: [Memory](../concepts/memory.md) Optional: choose a different workspace with `agents.defaults.workspace` (supports `~`).
...
-   Cron + wakeups: [Cron jobs](../automation/cron-jobs.md)
-   macOS menu bar companion: [OpenClaw macOS app](../platforms/macos.md)
-   iOS node app: [iOS app](../platforms/ios.md)
-   Android node app: [Android app](../platforms/android.md)
-   Windows status: [Windows (WSL2)](../platforms/windows.md)
-   Linux status: [Linux app](../platforms/linux.md)
-   Security: [Security](../gateway/security.md)

[Onboarding: macOS App](./onboarding.md)[CLI reference](./wizard-cli-reference.md)
