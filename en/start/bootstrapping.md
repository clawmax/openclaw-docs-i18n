...
> **ℹ️** When the Gateway runs on another machine, edit workspace files on the gateway host (for example, `user@gateway-host:~/.openclaw/workspace`).
...
[OAuth](../concepts/oauth.md)[Session Management](../concepts/session.md)
