...
-   Full Android setup details: [Android App](../platforms/android.md)
...
Run gateway smoke with tools + image: `OPENCLAW_LIVE_GATEWAY_MODELS="openai/gpt-5.2,openai-codex/gpt-5.4,anthropic/claude-opus-4-6,google/gemini-3-pro-preview,google/gemini-3-flash-preview,google-antigravity/claude-opus-4-6-thinking,google-antigravity/gemini-3-flash,zai/glm-4.7,minimax/minimax-m2.5" pnpm test:live src/gateway/gateway-models.profiles.live.test.ts`
...
What’s still missing for skills (see [Skills](../tools/skills.md)):
...
[Debugging](./debugging.md)[Scripts](./scripts.md)
