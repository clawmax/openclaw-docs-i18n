...
See [Configuration: Env var substitution](../gateway/configuration.md#env-var-substitution-in-config) for full details.
...
Both resolve from process env at activation time. SecretRef details are documented in [Secrets Management](../gateway/secrets.md).
...
-   [FAQ: env vars and .env loading](./faq.md#env-vars-and-env-loading)
-   [Models overview](../concepts/models.md)

[OpenClaw Lore](../start/lore.md)[Debugging](./debugging.md)
