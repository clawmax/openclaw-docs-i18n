...
Auth monitoring scripts are documented here: [/automation/auth-monitoring](../automation/auth-monitoring.md)
...
[Testing](./testing.md)[Node + tsx Crash](../debug/node-issue.md)
