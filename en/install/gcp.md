...
This guide uses Debian on GCP Compute Engine. Ubuntu also works; map packages accordingly. For the generic Docker flow, see [Docker](./docker.md).
...
-   Set up messaging channels: [Channels](../channels.md)
-   Pair local devices as nodes: [Nodes](../nodes.md)
-   Configure the Gateway: [Gateway configuration](../gateway/configuration.md)
