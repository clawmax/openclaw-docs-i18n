...
See [Security](../gateway/security.md) and [VPS hosting](../vps.md).
...
If you are on another Linux VPS, map packages accordingly. For the generic Docker flow, see [Docker](./docker.md).
