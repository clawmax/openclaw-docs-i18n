...
-   Secrets guide: [Secrets Management](../gateway/secrets.md)
-   Credential surface: [SecretRef Credential Surface](../reference/secretref-credential-surface.md)
-   Security guide: [Security](../gateway/security.md)
...
-   Canonical supported surface: [SecretRef Credential Surface](../reference/secretref-credential-surface.md).
...
[Sandbox CLI](./sandbox.md)[security](./security.md)
