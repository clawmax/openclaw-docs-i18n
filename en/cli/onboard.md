...
-   CLI onboarding hub: [Onboarding Wizard (CLI)](../start/wizard.md)
-   Onboarding overview: [Onboarding Overview](../start/onboarding-overview.md)
-   CLI onboarding reference: [CLI Onboarding Reference](../start/wizard-cli-reference.md)
-   CLI automation: [CLI Automation](../start/wizard-cli-automation.md)
-   macOS onboarding: [Onboarding (macOS App)](../start/onboarding.md)
...
-   Local onboarding DM scope behavior: [CLI Onboarding Reference](../start/wizard-cli-reference.md#outputs-and-internals).
...
> **ℹ️** `--json` does not imply non-interactive mode. Use `--non-interactive` for scripts.
