...
-   MS Teams: conversation id (`19:...@thread.tacv2`) or `conversation:` or `user:<aad-object-id>`
...
See [Discord components](../channels/discord.md#interactive-components) for the full schema. Create a Discord poll:
