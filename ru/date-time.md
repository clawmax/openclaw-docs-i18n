title: "Конфигурация даты и времени в OpenClaw для сообщений и промптов"
description: "Узнайте, как OpenClaw обрабатывает временные метки, часовые пояса и форматирование дат для конвертов сообщений, системных промптов и полезных данных инструментов. Настройте локальное время, UTC или время пользователя."
keywords: ["временные метки openclaw", "часовой пояс конверта сообщений", "конфигурация часового пояса пользователя", "дата и время системного промпта", "нормализация временных меток", "автоопределение формата времени", "нативные временные метки провайдера"]
---
