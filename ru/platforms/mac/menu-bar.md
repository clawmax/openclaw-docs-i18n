title: "Руководство по состоянию и активности приложения OpenClaw в строке меню macOS"
description: "Узнайте, как приложение OpenClaw в строке меню macOS отображает состояния работы агента, приоритет сессии, значки активности и отладочные переопределения для мониторинга AI-задач."
keywords: ["строка меню macos", "приложение openclaw companion", "состояние работы агента", "мониторинг активности", "приоритет сессии", "отладочное переопределение", "enum iconstate", "прием событий"]
---
