title: "ClawHub — публичный реестр навыков для OpenClaw AI агентов"
description: "Узнайте, как использовать ClawHub для поиска, установки и публикации публичных навыков для OpenClaw. Просматривайте реестр, используйте команды CLI и расширяйте возможности вашего AI-агента."
keywords: ["clawhub", "навыки openclaw", "реестр навыков", "инструменты ai агента", "clawhub cli", "публикация навыков", "установка навыков", "поиск навыков"]
---
