title: "OpenClaw Skills: Расположение, Приоритет и Конфигурация"
description: "Узнайте, как управлять навыками OpenClaw: установка, настройка и понимание приоритета загрузки для встроенных, локальных и рабочих навыков."
keywords: ["навыки openclaw", "agentskills", "конфигурация навыков", "clawhub", "приоритет навыков", "метаданные навыков", "ограничение навыков", "инструменты openclaw"]
---
