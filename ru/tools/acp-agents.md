title: "Руководство по агентам OpenClaw ACP для внешних сред выполнения кода"
description: "Узнайте, как использовать агенты OpenClaw ACP для запуска внешних сред выполнения кода, таких как Claude Code и Codex. Настройте сессии, управляйте средой выполнения и настройте бэкенд acpx."
keywords: ["acp агенты", "протокол агент-клиент", "openclaw acp", "acpx бэкенд", "среда выполнения кода", "claude code", "codex", "координация агентов"]
---
