title: "Руководство по суб-агентам OpenClaw для координации агентов и параллельных задач"
description: "Узнайте, как использовать суб-агентов для выполнения фоновых задач параллельно, управления привязанными к тредам сессиями и контроля координации агентов с помощью слеш-команд и конфигурации."
keywords: ["суб-агенты", "координация агентов", "параллельные задачи", "фоновые агенты", "привязка к тредам", "слеш-команды", "sessions_spawn", "openclaw"]
---
