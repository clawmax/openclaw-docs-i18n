title: "Документация по инструменту OpenClaw PDF для анализа PDF-документов"
description: "Узнайте, как использовать инструмент OpenClaw PDF для анализа и извлечения текста из PDF-файлов. Настраивайте модели, обрабатывайте входные данные и понимайте режимы выполнения для одного или нескольких документов."
keywords: ["инструмент pdf", "анализ pdf", "openclaw pdf", "обработка документов", "извлечение из pdf", "ai pdf", "интеграция pdf", "мультимодальный искусственный интеллект"]
---
