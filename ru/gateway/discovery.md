title: "Методы обнаружения и транспорта OpenClaw Gateway: объяснение"
description: "Узнайте, как OpenClaw обрабатывает сетевое обнаружение, сопряжение клиентов и выбор транспорта между шлюзами и управляющими приложениями с использованием Bonjour, Tailnet и SSH."
keywords: ["openclaw", "шлюз", "обнаружение", "bonjour", "tailscale", "websocket", "сопряжение", "ssh транспорт"]
---
