title: "Справочник по поверхности учетных данных SecretRef для OpenClaw AI"
description: "Узнайте, какие поля конфигурации OpenClaw поддерживают внешние секреты через SecretRef для безопасного управления учетными данными в моделях, агентах, каналах и инструментах."
keywords: ["secretref", "учетные данные openclaw", "управление api ключами", "секреты конфигурации", "внешние секреты", "поверхность учетных данных", "аудит секретов", "профили аутентификации"]
---
