title: "Руководство по тестированию OpenClaw AI: команды, бенчмарки и Docker"
description: "Узнайте, как запускать тесты OpenClaw AI, включая модульные, интеграционные и live-тесты. Получите команды для проверки покрытия, бенчмарков и сквозного тестирования на основе Docker."
keywords: ["тестирование openclaw", "команды vitest", "docker e2e тесты", "покрытие тестами", "бенчмарки cli", "интеграция шлюза", "pnpm test", "бенчмарк задержки модели"]
---
