title: "Руководство по шаблону AI-агентов OpenClaw для управления сессиями и памятью"
description: "Узнайте, как настраивать и управлять AI-агентами с помощью шаблона OpenClaw. Это руководство охватывает запуск сессии, обработку памяти, поведение в групповых чатах и проактивные задачи heartbeat."
keywords: ["openclaw ai", "шаблон агентов", "управление сессиями", "память ИИ", "задачи heartbeat", "правила группового чата", "документация ИИ", "конфигурация агента"]
---
