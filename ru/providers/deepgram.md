title: "Настройка Deepgram для транскрипции аудио в OpenClaw"
description: "Узнайте, как настроить и использовать провайдер Deepgram для транскрипции входящих аудиосообщений и голосовых заметок в OpenClaw, включая настройку API-ключа и параметров конфигурации."
keywords: ["deepgram", "речь в текст", "транскрипция аудио", "openclaw", "голосовые заметки", "nova-3", "настройка провайдера", "обработка аудио"]
---
