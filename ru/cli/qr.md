title: "Команда openclaw qr для сопряжения и настройки iOS"
description: "Узнайте, как использовать команду openclaw qr для генерации QR-кодов сопряжения iOS и кодов настройки из конфигурации вашего шлюза для настройки устройств."
keywords: ["openclaw qr", "qr код сопряжения ios", "код настройки шлюза", "сопряжение через cli", "сопряжение устройств", "openclaw cli", "генерация qr кода", "настройка homekit"]
---
