title: "Команды CLI OpenClaw Directory для поиска в каналах"
description: "Узнайте, как использовать команду directory CLI OpenClaw для поиска ID пользователей, групп и контактов в WhatsApp, Slack, Discord и других каналах для обмена сообщениями."
keywords: ["openclaw directory", "cli поиск в директории", "контакты канала", "найти id пользователя", "цель сообщения", "список участников", "список групп", "команды cli"]
---
