title: "Список команд sessions и руководство по очистке в OpenClaw CLI"
description: "Узнайте, как просматривать и управлять сохранёнными сессиями диалогов с помощью OpenClaw CLI. Просматривайте данные сессий, выполняйте очистку и используйте опции вывода JSON."
keywords: ["openclaw sessions", "команда cli sessions", "очистка сессий", "сессии диалогов", "обслуживание сессий", "команды cli", "управление сессиями", "вывод json"]
---
