title: "Команда CLI OpenClaw Doctor для проверки состояния и быстрого исправления"
description: "Узнайте, как использовать команду openclaw doctor для запуска проверок состояния, исправления проблем и диагностики шлюза и каналов. Включает примеры и советы для macOS."
keywords: ["openclaw doctor", "проверка состояния cli", "диагностика шлюза", "исправление cli", "устранение неполадок openclaw", "macos launchctl", "команды cli", "системная диагностика"]
---
