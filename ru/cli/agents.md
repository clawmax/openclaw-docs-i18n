title: "Руководство по командам CLI OpenClaw для управления изолированными рабочими пространствами агентов"
description: "Узнайте, как управлять изолированными агентами, настраивать привязки маршрутизации и задавать идентификаторы агентов с помощью команд CLI OpenClaw. Включает примеры для list, add, bind и set-identity."
keywords: ["агенты openclaw", "cli агенты", "рабочее пространство агента", "привязки маршрутизации", "set-identity", "многопользовательская маршрутизация", "привязки агентов", "команды cli"]
---
