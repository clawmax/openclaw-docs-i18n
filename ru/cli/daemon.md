title: "Команды CLI демона OpenClaw для управления службой Gateway"
description: "Узнайте, как использовать устаревшие команды CLI демона openclaw для установки, запуска, остановки и управления состоянием и жизненным циклом службы Gateway."
keywords: ["демон openclaw", "служба gateway", "команды cli", "управление службой", "установка службы", "статус службы", "устаревший алиас", "openclaw cli"]
---
