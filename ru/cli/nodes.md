title: "Команды управления подключенными устройствами (nodes) в OpenClaw CLI"
description: "Узнайте, как выводить список, утверждать и выполнять команды на подключенных узлах (устройствах) с помощью OpenClaw CLI. Управляйте статусом узлов и запускайте shell-команды."
keywords: ["openclaw cli", "узлы", "управление устройствами", "команды cli", "вызов узла", "статус узла", "подключенные устройства", "system run"]
---
