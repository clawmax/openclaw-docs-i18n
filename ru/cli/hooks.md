title: "Управление хуками OpenClaw CLI: Автоматизации на основе событий агента"
description: "Узнайте, как управлять хуками агента OpenClaw: список, включение, отключение, установка и обновление автоматизаций на основе событий для команд, таких как /new и запуск шлюза."
keywords: ["хуки openclaw", "cli хуки", "автоматизация агента", "хуки на основе событий", "командные хуки", "запуск шлюза", "управление хуками", "память сессии"]
---
