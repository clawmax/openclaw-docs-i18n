title: "Управление памятью OpenClaw: сессии, инструменты и векторный поиск"
description: "Узнайте, как работает память OpenClaw с файлами Markdown, инструментами поиска по памяти и векторным индексированием. Настройте автоматическую очистку памяти и экспериментальный бэкенд QMD."
keywords: ["память openclaw", "память агента", "векторный поиск по памяти", "инструменты памяти", "компактизация сессий", "бэкенд qmd", "память markdown", "управление памятью"]
---
