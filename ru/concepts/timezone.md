title: "Конфигурация часового пояса OpenClaw для временных меток и системных промптов"
description: "Узнайте, как OpenClaw стандартизирует временные метки, настраивает часовой пояс конверта сообщений и устанавливает часовой пояс пользователя для системных промптов. Управляйте отображением времени для AI-моделей."
keywords: ["часовой пояс openclaw", "стандартизация временных меток", "конверт сообщения", "iana часовой пояс", "часовой пояс пользователя", "системный промпт", "конфигурация временных меток", "нормализация utc"]
---
