title: "Расширение OpenProse для AI-воркфлоу в OpenClaw"
description: "Узнайте, как использовать OpenProse — формат, ориентированный на markdown, для оркестрации сессий с несколькими AI-агентами. Установите плагин, используйте слэш-команды и управляйте состоянием."
keywords: ["openprose", "ai воркфлоу", "мульти-агент", "плагин openclaw", "prose.md", "формат markdown", "слэш команда", "управление состоянием"]
---
